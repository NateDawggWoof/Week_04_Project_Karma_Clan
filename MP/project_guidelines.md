...
Presentations will be held on Thursday morning. You will have **10 minutes** to present your work, with 5 minutes for questions.
...
* Show code in VSCode. Instead take screenshots using tools like [Polacode](https://marketplace.visualstudio.com/items?itemName=pnp.polacode) or [Carbon](https://carbon.now.sh/)
